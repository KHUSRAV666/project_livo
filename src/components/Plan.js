...
export default function Plan() {
  return (
    <>
        <div className="bg-gradient-to-b from-[#F8F8F8_-45.04%] to-[rgba(248, 248, 248, 0)_88.56%] pt-[80px] max-sm:pt-[10px]">
            {/* plan satart */}
            <div className="flex flex-col items-center mb-[60px] max-sm:mb-[20px] lg:text-5xl sm0:text-3xl max-sm0:text-2xl">
                <h1 className="font-medium leading-[50px] text-[#0B132A] mb-[20px]">Choose Your Plan</h1>
            ...
            <div className="sm:flex sm:justify-around">
                <div className="sm:w-80 h-[47.5rem] pt-20 max-sm:pt-6 max-sm:mb-2 pb-[3.125rem] border-2 border-myBorder rounded-lg flex flex-col flex-wrap justify-between">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <span className="cursor-pointer w-[178px] h-[45px] leading-[14px] text-center text-[#f53838] border-2 border-[#f53838] rounded-full block px-11 py-3 font-bold hover:text-white hover:bg-[#f53838] hover:shadow-2xl hover:shadow-[#fbafaf] shadow:blur-[27px]">
                            Select
                        </span>
                    </div>
                </div>
